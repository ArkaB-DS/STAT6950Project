...
p1 <- ggplot(data = data.frame(ACE$y, ACE$ty), aes(x=ACE$y, y = ACE$ty)) +
  ...
  labs(
    x= "NFCR2019",
    y = "Transformed NFCR2019"
  )
p2 <- ggplot(data = data.frame(x=ACE$x[1, ], y=ACE$tx[, 1]), aes(x=x, y = y)) +
  geom_line(linetype= "dashed", color= "red")+
  labs(
    x= "CPI2019",
    y = "Transformed CPI2019"
  )
p3 <- ggplot(data = data.frame(x=ACE$x[2, ], y=ACE$tx[, 2]), aes(x=x, y = y)) +
  geom_line(linetype= "dashed", color= "red")+
  labs(
    x= "AML2019",
    y = "Transformed AML2019"
  )
p4 <- ggplot(data = data.frame(x=ACE$x[3, ], y=ACE$tx[, 3]), aes(x=x, y = y)) +
  geom_line(linetype= "dashed", color= "red")+
  labs(
    x= "ARR2019",
    y = "Transformed ARR2019"
  )
p5 <- ggplot(data = data.frame(x=ACE$x[4, ], y=ACE$tx[, 4]), aes(x=x, y = y)) +
  geom_line(linetype= "dashed", color= "red")+
  labs(
    x= "WES2019",
    y = "Transformed WES2019"
  )
p6 <- ggplot(data = data.frame(x=ACE$x[1, ], y=ACE$tx[, 1]), aes(x=x, y = y)) +
  geom_line(linetype= "dashed", color= "red")+
  labs(
    x= "GE2019",
    y = "Transformed GE2019"
  )
p7 <- ggplot(data = data.frame(x=ACE$x[1, ], y=ACE$tx[, 1]), aes(x=x, y = y)) +
  geom_line(linetype= "dashed", color= "red")+
  labs(
    x= "PV2019",
    y = "Transformed PV2019"
  )
p8 <- ggplot(data = data.frame(x=ACE$x[1, ], y=ACE$tx[, 1]), aes(x=x, y = y)) +
  geom_line(linetype= "dashed", color= "red")+
  labs(
    x= "RQ2019",
    y = "Transformed RQ2019"
  )
p9 <- ggplot(data = data.frame(x=ACE$x[1, ], y=ACE$tx[, 1]), aes(x=x, y = y)) +
  geom_line(linetype= "dashed", color= "red")+
  labs(
    x= "RL2019",
    y = "Transformed RL2019"
  )
p10 <- ggplot(data = data.frame(x=ACE$x[1, ], y=ACE$tx[, 1]), aes(x=x, y = y)) +
  geom_line(linetype= "dashed", color= "red")+
  labs(
    x= "VA2019",
    y = "Transformed VA2019"
  )
p11 <- ggplot(data = data.frame(x=ACE$x[1, ], y=ACE$tx[, 1]), aes(x=x, y = y)) +
  geom_line(linetype= "dashed", color= "red")+
  labs(
    x= "RGDP2019",
    y = "Transformed RGDP2019"
  )
